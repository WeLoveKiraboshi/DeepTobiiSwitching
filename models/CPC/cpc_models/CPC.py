from models.CPC.cpc_models.InfoNCE_Loss import InfoNCE_Loss
...
class CPC(nn.Module):
    ...
    def __init__(self, encoderNet, arNet, pred_directions, pred_steps, neg_samples, is_eval=False):
        super().__init__()
    ...
    def load_state_dict_imagenet(self):
        self.enc.load_state_dict(torch.load('./resnet18-5c106cde.pth'))
