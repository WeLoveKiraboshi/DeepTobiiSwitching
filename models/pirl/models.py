...
class PIRLResnet(nn.Module):
    def __init__(self, resnet_module, non_linear_head=False):
        ...
        self.resnet_module = resnet_module
        self.lin_project_1 = nn.Linear(512, 64)
        self.lin_project_2 = nn.Linear(64 * 9, 64)
        if non_linear_head:
            self.lin_project_3 = nn.Linear(64, 64)  # Will only be used if non_linear_head is True
