...
from models.modules.identity import Identity
...
class SwAV_Resnet18(nn.Module):
    def __init__(
        ...
        super(SwAV_Resnet18, self).__init__()
        self.encoder = encoder
        # Replace the fc layer with an Identity function
        self.n_features = self.encoder.fc.in_features  # output dim of Resnet18
        ...
        if output_dim == 0:
            ...
            self.projection_head = nn.Sequential(
                nn.Linear(self.n_features, hidden_mlp),
